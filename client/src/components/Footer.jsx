...
const Footer = () => {
 ...
 <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6 mt-20">
            ...
            <p className="pt-4 text-center text-xs md:text-sm pb-5">
                Copyright 2025 © <a href="https://github.com/OlaoyeData">Faith Olaoye</a>. All Right Reserved.
            </p>
        </footer>
  )
}
