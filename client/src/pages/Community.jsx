      ...
      <div className="bg-white h-full w-full rounded-xl overflow-y-scroll">
        {creations.map((creation, index)=> (
          <div key={index} className="relative group inline-block pl-3 pt-3 w-full sm:max-w-1/2 lg:max-w-1/3">
            ...
            <div className="absolute bottom-0 left-3 right-0 top-0 flex gap-2 items-end justify-end p-3 group-hover:justify-between group-hover:bg-linear-to-b from-transparent to-black/80 text-white rounded-lg ">
